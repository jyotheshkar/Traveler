...
<h2 className='p-4' > Top 1% Locations WorldWide </h2>
<form className='flex justify-between items-center max-w-[700px] mx-auto w-full border p-1 
rounded-md text-black bg-gray-100/90  '  >
<div  > 
    <input className='bg-transparent w-[300px] focus:outline-none sm:w-[400px] font-[Roboto]  ' type="text"  placeholder='Search Destinations' />
    </div>
    <div>
